...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Becker", href: "/assistencia-tecnica-becker" },
      { label: "Cozil", href: "/assistencia-tecnica-cozil" },
      { label: "G.Paniz", href: "/assistencia-tecnica-gpaniz" },
      { label: "Gelopar", href: "/assistencia-tecnica-gelopar" },
      { label: "Hobart", href: "/assistencia-tecnica-hobart" },
      { label: "Hoshizaki", href: "/assistencia-tecnica-hoshizaki" },
      { label: "Imbera", href: "/assistencia-tecnica-imbera" },
      { label: "Irinox", href: "/assistencia-tecnica-irinox" },
      { label: "Macom", href: "/assistencia-tecnica-macom" },
      { label: "Middleby", href: "/assistencia-tecnica-middleby" },
      { label: "Netter", href: "/assistencia-tecnica-netter" },
      { label: "Prática", href: "/assistencia-tecnica-pratica" },
      { label: "Progás", href: "/assistencia-tecnica-progas" },
      { label: "Ramalhos", href: "/assistencia-tecnica-ramalhos" },
      { label: "Robot Coupe", href: "/assistencia-tecnica-robot-coupe" },
      { label: "Rodriaço", href: "/assistencia-tecnica-rodriaco" },
      { label: "Skymsen", href: "/assistencia-tecnica-skymsen" },
      { label: "Tramontina", href: "/assistencia-tecnica-tramontina" },
      { label: "Unox", href: "/assistencia-tecnica-unox" },
      { label: "Vulcan", href: "/assistencia-tecnica-vulcan" },
      { label: "Winterhalter", href: "/assistencia-tecnica-winterhalter" },
    ],
  },
